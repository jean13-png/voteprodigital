...
const socialLinks = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61592861075000",
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/prodigital.center?stkn=bThzYmwzcDBxY25z",
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@prodigitalcenter",
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@prodigital.center?_r=1&_t=ZS-99s7KK4xSLJ",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 xl:gap-10">
          ...
          <div>
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Plateforme officielle de vote du Bootcamp Digital Academy.
              Soutenez votre candidat et rejoignez la communauté ProDigital Center.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-white/40 text-xs">
            &copy; {new Date().getFullYear()} ProDigital Center. Tous droits réservés.
          </p>
          <p className="text-white/40 text-xs">
            Bootcamp Digital Academy, soutenance 2026
          </p>
        </div>
      </div>
    </footer>
